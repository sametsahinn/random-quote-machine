...
const App = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(FontAwesomeIcon, { icon: faQuoteLeft }), " ", /*#__PURE__*/React.createElement("span", { id: "text" }, quote.text)), /*#__PURE__*/

    React.createElement("div", { class: "quote-author" }, "- ", /*#__PURE__*/
    React.createElement("span", { id: "author" }, quote.author)), /*#__PURE__*/

    React.createElement("div", { class: "buttons" }, /*#__PURE__*/
    React.createElement("a", { href: tweetUrl, class: "button", id: "tweet-quote", title: "Tweet this quote!", target: "_blank" }, /*#__PURE__*/
    React.createElement(FontAwesomeIcon, { icon: faTwitter })), /*#__PURE__*/

    React.createElement("a", { href: tumblrUrl, class: "button", id: "tumblr-quote", title: "Post this quote on tumblr!", target: "_blank" }, /*#__PURE__*/
    React.createElement(FontAwesomeIcon, { icon: faTumblr })), /*#__PURE__*/

    React.createElement("button", { class: "button", id: "new-quote", onClick: getNewQuote }, "New quote"))));
